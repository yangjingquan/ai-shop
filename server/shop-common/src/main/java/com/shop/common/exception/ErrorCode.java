...
public enum ErrorCode {
    ...
    CART_QUANTITY_EXCEEDED(125, "购物车商品数量超出限制"),
    ...
    WX_PAY_CALLBACK_AMOUNT_MISMATCH(152, "微信支付回调金额不一致"),
    ...
    PRODUCT_HAS_ACTIVE_ORDERS(213, "商品存在进行中的订单，暂不能替换规格"),
    BANNER_NOT_FOUND(220, "轮播图不存在"),
    FILE_NOT_OWNED(222, "文件不存在或不属于当前用户"),
