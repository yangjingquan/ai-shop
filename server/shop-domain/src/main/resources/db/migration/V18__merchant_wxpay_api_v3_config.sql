ALTER TABLE merchant
    ADD COLUMN wx_pay_api_v3_key VARCHAR(256) DEFAULT '' COMMENT '微信支付 API v3 密钥（AES-GCM 密文）' AFTER wx_mch_id,
    ADD COLUMN wx_pay_mch_serial_no VARCHAR(128) DEFAULT '' COMMENT '微信支付商户 API 证书序列号' AFTER wx_pay_api_v3_key,
    ADD COLUMN wx_pay_private_key TEXT COMMENT '微信支付商户 API 私钥 PEM（AES-GCM 密文）' AFTER wx_pay_mch_serial_no,
