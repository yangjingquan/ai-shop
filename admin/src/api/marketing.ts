...
export interface MemberLevel { id?: number; level?: number; name: string; minTotalPoints: number; maxTotalPoints?: number | null }
...
export const pointsApi = {
  ...
  levels: () => request.get<unknown, MemberLevel[]>('/api/merchant/points/levels'), saveLevels: (data: MemberLevel[]) => request.put<unknown, void>('/api/merchant/points/levels', data),
